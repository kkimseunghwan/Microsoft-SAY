...
CREATE SEQUENCE Apr01_Students_Seq; -- 테이블명_seq (암묵적 룰)
-- SEQUENCE 삭제
--		DROP SEQUENCE 시퀀스명;
...
INSERT INTO Apr01_Students 
	VALUES(Apr01_Students_Seq.nextval, '홍길동', 
		to_date('2003-05-05', 'YYYY-MM-DD'),100, 90, 80);

INSERT INTO Apr01_Students 
	VALUES(Apr01_Students_Seq.nextval, '김길동', 
		to_date('2003-12-15', 'YYYY-MM-DD'), 90, 50, 20);

INSERT INTO Apr01_Students 
	VALUES(Apr01_Students_Seq.nextval, '박철수', 
...
-- FROM 테이블 명
-- * = 전체
SELECT * FROM Apr01_Students;

-- 학생 이름, 국어만 조회하고 싶음.
SELECT s_name, s_kor FROM Apr01_Students;
